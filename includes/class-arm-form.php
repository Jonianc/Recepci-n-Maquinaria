...
<script src="<?php echo esc_url(ARM_PLUGIN_URL . 'assets/js/form.js?ver=' . rawurlencode((string) ARM_PLUGIN_VERSION)); ?>"></script>
</body>
</html>
        <?php
    ...
    private function default_implement_types(): array {
        return ['Segadora', 'Trituradora', 'Pulverizador'];
    }

    private function get_implement_types(): array {
        $raw = (string) get_option(ARM_Settings::OPT_IMPLEMENT_TYPES, implode("\n", $this->default_implement_types()));
        ...
        return $out ?: $this->default_implement_types();
    }
                ...
                <section class="arm-step" data-step="2">
                    ...
                    <div class="arm-grid">
                        ...
                        <div class="arm-field arm-only-implemento" style="display:none;">
                            ...
                            <div class="arm-inline">
                                <?php foreach ($this->get_implement_types() as $tipo_implemento): ?>
                                    <label class="arm-chip"><input type="radio" name="arm_tipo_implemento" value="<?php echo esc_attr($tipo_implemento); ?>"> <?php echo esc_html($tipo_implemento); ?></label>
                                <?php endforeach; ?>
                            </div>
                        </div>
                        ...
                        <div class="arm-field arm-only-implemento" style="display:none;">
                            ...
                            <div class="arm-inline arm-wrap-line">
                                ...
                                <label class="arm-chip"><input type="radio" name="arm_marca_implemento" value="__other__"> Otra</label>
                            </div>
                            <div id="arm_marca_implemento_otra_wrap" class="arm-field" style="display:none;margin-top:10px;">
                                <label for="arm_marca_implemento_otra"><strong>Marca (implemento) manual</strong><span class="arm-required">*</span></label>
                                <input id="arm_marca_implemento_otra" class="arm-input" type="text" name="arm_marca_implemento_otra" autocomplete="off">
                            </div>
                        </div>
    ...
    public function handle_post(): void {
        ...
        $marca_implemento = ($tipo === 'Implemento') ? ARM_Utils::sanitize_text($_POST['arm_marca_implemento'] ?? '') : '';
        $marca_implemento_otra = ($tipo === 'Implemento') ? ARM_Utils::sanitize_text($_POST['arm_marca_implemento_otra'] ?? '') : '';
        if ($tipo === 'Implemento' && $marca_implemento === '__other__') {
            if ($marca_implemento_otra === '') {
                $this->redirect_err('Marca de implemento manual obligatoria');
            }
            $meta['arm_marca_implemento'] = $marca_implemento_otra;
        } else {
            $meta['arm_marca_implemento'] = $marca_implemento;
        }
